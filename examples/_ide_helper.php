...
/**
 * @var  static  bool  exists = false  Indicates if the model exists.
 * @var  static  bool  incrementing = true  Indicates if the IDs are auto-incrementing.
 * @var  static  bool  snakeAttributes = true  Indicates whether attributes are snake cased on arrays.
 * @var  static  bool  timestamps = true  Indicates if the model should be timestamped.
...
/**
 * @var  static  \Symfony\Component\HttpFoundation\ParameterBag  attributes = null  
 * @var  static  \Symfony\Component\HttpFoundation\ParameterBag  cookies = null  
 * @var  static  \Symfony\Component\HttpFoundation\FileBag  files = null  
 * @var  static  \Symfony\Component\HttpFoundation\HeaderBag  headers = null  
 * @var  static  \Symfony\Component\HttpFoundation\ParameterBag  query = null  
 * @var  static  \Symfony\Component\HttpFoundation\ParameterBag  request = null  
 * @var  static  \Symfony\Component\HttpFoundation\ServerBag  server = null  
...
/**
 * @method  static  void                             addNamespace( string $namespace, string $hint)  Add a new namespace to the loader.
 * @method  static  string                           choice(  $key, int $number, array $parameters = array(), string $locale = null, string $id)  Get a translation according to an integer value.
 * @method  static  string                           get(  $key, array $parameters = array(), string $locale = null, string $id)  Get the translation for a given key.
...
/**
 * @method  static  \Symfony\Component\HttpFoundation\BinaryFileResponse  download( \SplFileInfo $file, int $status = "200", array $headers = array())  Create a new file download response.
